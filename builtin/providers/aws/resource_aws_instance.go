...
func resourceAwsInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	//   See https://github.com/eugenetaranov/terraform/issues/3798
	...
	if v, ok := d.GetOk("root_block_device"); ok {
		...
		for _, v := range vL {
			...
			if v, ok := bd["iops"].(int); ok && v > 0 && *ebs.VolumeType == "io1" {
				...
				//   See https://github.com/eugenetaranov/terraform/pull/4146
				//   See https://github.com/eugenetaranov/terraform/issues/7765
				ebs.Iops = aws.Int64(int64(v))
